...
- Child ticket: `.scratch/<effort>/issues/NN-<slug>.md`, numbered from `01`, with the question in the body; a `Type:` line records the ticket type (`research`, `prototype`, `grilling`, or `task`), and a `Status:` line records `claimed` or `resolved`
